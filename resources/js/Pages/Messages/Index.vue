...
const fetchMessages = async () => {
    ...
    try {
        const response = await axios.get(
            route("messages.show", selectedConversation.value.id),
        );
...
<template>
    ...
    <PulseBidLayout>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div
                class="bg-surface-container rounded-3xl overflow-hidden shadow-ambient border border-white/5 flex h-[calc(100vh-180px)]"
            >
                <!-- Sidebar -->
                <div
                    class="w-full md:w-80 border-r border-white/5 flex flex-col bg-surface-lowest/30"
                >
                    <div class="p-6">
                        ...
                        <div class="relative">
                            ...
                            />
                            <svg
                                class="absolute left-3.5 top-3.5 w-4 h-4 text-white/20"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                            >
                    ...
                    <div class="flex-1 overflow-y-auto custom-scrollbar">
                        ...
                        >
                            <p class="text-sm text-white/20 italic">
                        ...
                        <button
                            ...
                            :class="
                                selectedConversation?.id === conv.id
                                    ? 'bg-primary/5 border-primary shadow-[inset_0_0_20px_rgba(165,255,184,0.05)]'
                                    : 'border-transparent'
                            "
                        >
                            <!-- Avatar -->
                            <div
                                class="w-12 h-12 rounded-full bg-gradient-to-br from-surface-bright to-surface-container border border-white/10 flex items-center justify-center font-bold text-white/40 overflow-hidden shrink-0"
                            >
                                <img
                                ...
                                <div
                                    ...
                                    class="absolute bottom-0 right-0 w-3 h-3 bg-primary rounded-full border-2 border-surface-container"
                                ></div>
                            </div>
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                >
                                    ...
                                    <span
                                        class="text-[10px] text-white/20 uppercase tracking-tighter"
                                    >
                                        {{
                                            conv.latest_message
                                                ? formatDate(
                ...
                <div class="flex-1 flex flex-col bg-surface-lowest/10 relative">
                    <template v-if="selectedConversation">
                        <!-- Chat Header -->
                        <div
                            class="p-4 border-b border-white/5 flex items-center justify-between backdrop-blur-md bg-surface-container/30 sticky top-0 z-10"
                        >
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-10 h-10 rounded-full bg-surface-bright flex items-center justify-center font-bold text-white/30 overflow-hidden"
                                >
                                    <img
                                        v-if="
                                ...
                                <div>
                                    ...
                                    <p
                                        class="text-[10px] text-primary flex items-center gap-1 uppercase tracking-widest font-bold"
                                    >
                                        <span
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div
                                        v-if="msg.type === 'file'"
                                        class="mt-2 bg-black/10 rounded-xl p-3 flex items-center gap-3 min-w-[240px]"
                                    >
                                        <div
                                            class="w-10 h-10 rounded-lg bg-black/20 flex items-center justify-center shrink-0"
                                        >
                                            <svg
                                        ...
                                        <a
                                            ...
                                            target="_blank"
                                            class="p-2 hover:bg-black/10 rounded-full"
                                        >
                                            <svg
                                    ...
                                    <div
                                        class="flex items-center gap-1 mt-2 float-right opacity-40"
                                    >
                                        <span
                            ...
                            <div class="flex justify-center py-4">
                                <span
                                    class="bg-secondary/10 text-secondary text-[10px] font-bold px-4 py-1.5 rounded-full flex items-center gap-2 uppercase tracking-widest border border-secondary/20 shadow-glow-blue"
                                >
                                    <span
                        ...
                        <!-- Chat Input -->
                        <div
                            class="p-6 bg-surface-lowest/50 backdrop-blur-md border-t border-white/5"
                        >
                            <form
                            ...
                            >
                                <button
                                    ...
                                    class="w-10 h-10 flex items-center justify-center rounded-2xl bg-surface-bright/50 text-white/40 hover:text-white transition-colors"
                                >
                                    <svg
                                        class="w-5 h-5"
                                        fill="none"
                                ...
                                <div class="flex-1 relative">
                                    ...
                                    <button
                                        type="button"
                                        class="absolute right-3 top-3 text-white/10 hover:text-white/40 transition-colors"
                                    >
                                        <svg
                                            class="w-5 h-5"
                                            fill="none"
                    ...
                    <div
                        v-else
                        class="flex-1 flex flex-col items-center justify-center text-center p-12 opacity-20"
                    >
                        <div
                            class="w-24 h-24 rounded-full bg-surface-bright flex items-center justify-center mb-6"
                        >
                            <svg
                                class="w-12 h-12"
                                fill="none"
                        ...
                        <p class="text-sm max-w-xs mx-auto">
                            Click on a conversation in the sidebar to start
                            messaging your seller or buyer.
                        </p>
                    </div>
                </div>
            </div>
